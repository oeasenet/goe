...
func NewGoeFiber(goeConfig *GoeConfig, l contracts.Logger) *GoeFiber {
	...
	fiberApp := fiber.New(fiber.Config{
		...
		TrustProxy:        goeConfig.Http.TrustProxyCheck,
		TrustProxyConfig: fiber.TrustProxyConfig{
			Proxies:   goeConfig.Http.TrustProxies,
			LinkLocal: true,
			Loopback:  true,
			Private:   true,
		},
...
func (gf *GoeFiber) CreateFiberApp(appName ...string) *fiber.App {
	...
	return fiber.New(fiber.Config{
		...
		JSONDecoder:       json.Unmarshal,
		XMLEncoder:        xml.Marshal,
		TrustProxy:        gf.goeConfig.Http.TrustProxyCheck,
		TrustProxyConfig: fiber.TrustProxyConfig{
			Proxies:   gf.goeConfig.Http.TrustProxies,
			LinkLocal: true,
			Loopback:  true,
			Private:   true,
		},
